...
const CASCADE_NOSE: &str = "/home/ANT.AMAZON.COM/fraber/src/moustache-rs/static/haarcascade_mcs_nose.xml";
const MOUSTACHE_PATH: &str = "/home/ANT.AMAZON.COM/fraber/src/moustache-rs/static/mustache.png";
...
fn main() {
    ...
    let moustacher = match Moustacher::new(cascade_face, String::from(CASCADE_NOSE), String::from(MOUSTACHE_PATH)) {
